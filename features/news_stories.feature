Feature: News
  ...
  Background:
    ...
    And a news exist with project: the project, author: the user, title: "My title"
  ...
  Scenario: Go to list of news
    ...
    When I follow "News"
    Then 3 news should exist with project: the project
  ...
  Scenario: Add new news
    ...
    When I fill in "Title" with "My Custom Title"
    ...
    And a news should exist with title: "My Custom Title"
  ...
  Scenario: Show news
    ...
    And I should be on the project the news page
